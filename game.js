...
playerImg.src = 'images/macaco.png.png';  // Substituindo o avião por um macaco
const bulletImg = new Image();
bulletImg.src = 'images/bala.png';   // Substituindo os tiros por bala
const fuelTankImg = new Image();
fuelTankImg.src = 'images/banana.png'; // Substituindo o combustível por banana
const enemyImg = new Image();
enemyImg.src = 'images/onca.png'; // Substituindo inimigos por onça (ou polícia)

// Variáveis do jogo
let score = 0;
let fuel = 100;
let speed = 2;
let player = { x: 200, y: 500, width: 60, height: 80 };
